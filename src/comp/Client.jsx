          ...
          {cards.map((d, index) => (
            ...
            >
              <img
                src={d.img}
                alt=""
                className="w-16 h-16 mt-3 md:mt-[76px]   "
              />
              <p className="font-centra-normal text-white text-[20px] mt-[15px] md:mt-[0px]">
                {d.description}
              </p>
              <h2 className="text-white text-[24px] font-centra-italic mt-6 md:mt-10 italic">
                {d.name}
              </h2>
            </div>
          ))}
